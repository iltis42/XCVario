...
class Polars {
	const t_polar polars_default[100];
public:
	Polars(): polars_default{
		{"UserPolar",34.40,80,-0.66,125,-0.97,175,-2.24},
		{"ASH 25e",43.00,80,-0.62,125,-0.72,175,-1.49},
		{"ASK 23",26.30,80,-0.69,125,-1.32,175,-2.93},
		{"ASK 13",21.71,70,-0.80,100,-1.20,150,-2.80},
		{"Astir CS",30.00,80,-0.61,125,-1.07,175,-2.45},
		{"Astir G-102",29.00,80,-0.70,125,-1.18,175,-2.55},
		{"Astir-Twin",33.40,80,-0.78,125,-1.07,175,-2.17},
		...
		{"G-103 Twin III",27.60,80,-0.75,120,-1.0,200,-3.4},
		...
		{"L+A7S 3a",32.60,80,-0.63,125,-0.96,175,-2.9},
		{"LS 1 f",35.50,80,-0.64,125,-1.07,175,-2.34},
		{"LS 3",35.50,80,-0.63,125,-0.92,175,-1.87},
		{"LS 4",34.40,80,-0.66,125,-0.97,175,-2.24},
		{"LS3/17",33.00,80,-0.56,125,-0.94,175,-2.44},
		{"LS 6a",33.3,100,-0.67,155,-1.48,212,-3.00},
		{"LS 7WL",35.97,103.77,-0.73,155.65,-1.47,180.00,-2.66},
		{"LS 8",34.28,100,-0.67,155,-1.45,185,-2.5},
		{"Mini Nimbus",34.20,80,-0.63,125,-0.96,175,-2.13},
		{"Mistral C",31.36,80,-0.67,125,-1.15,175,-2.64},
		{"Mosquito H-303",36.20,80,-0.63,125,-0.92,175,-1.99},
		{"Mosquito H-303B",34.00,80,-0.62,125,-0.93,175,-2.04},
		...
		{"Salto 15 H-101",31.20,80,-0.62,125,-1.24,175,-2.75},
		{"Salto H-101",31.60,80,-0.72,125,-1.32,175,-2.96},
		...
		{"SZD51-1 Junior",30.38,80,-0.65,125,-1.20,175,-2.80},
		...
		{"END-POLAR",0,0,0,0,0,0,0}  }  {};

		inline const t_polar getPolar( int x ) {
			if(x < numPolars())
				return polars_default[x];
			else
				return polars_default[numPolars()+1];
		};
		inline int     numPolars() {
			int N = 0;
			while( polars_default[N].type != "END-POLAR" )
				N++;
			return N;
		}
		virtual ~Polars();
