...
public:
	...
	void sendNmeaSEN( bool sensor=false, bool imu=false, float statTime=0, float statP=0, float teTime=0, float teP=0, float dynTime=0, float dynP=0, float OATemp=0, float MPUtempcel=0,
			...
			float accelTime=0, float ax=0, float ay=0, float az=0, float gyroTime=0,float gx=0, float gy=0, float gz=0);
