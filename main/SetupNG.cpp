...
SetupNG<float>          compass_damping( "CP_DAMP", 1.5 );
...
SetupNG<float>          wind_speed_delta( "WIND_V_Delta", 20 );
SetupNG<float>          wind_heading_delta( "WIND_H_Delta", 5 );
SetupNG<float>          wind_as_filter( "WIND_ASF", 0.001 );
...
SetupNG<float> 			wind_filter_lowpass("WIND_LPF", 0.05 );
...
SetupNG<float>       	max_circle_wind_diff("CI_WIND_DM", 40.0 );
SetupNG<float>       	circle_wind_lowpass("CI_WIND_LOW", 0.3 );
