...
SetupNG<int>            CP_enable( "CP_ENABLE", 0 );
SetupNG<float>          CP_dev_45( "CP_DEV_45", 0 );
SetupNG<float>          CP_dev_90( "CP_DEV_90", 0 );
SetupNG<float>          CP_dev_135( "CP_DEV_135", 0 );
SetupNG<float>          CP_dev_180( "CP_DEV_180", 0 );
SetupNG<float>          CP_dev_225( "CP_DEV_225", 0 );
SetupNG<float>          CP_dev_270( "CP_DEV_279", 0 );
SetupNG<float>          CP_dev_335( "CP_DEV_335", 0 );
SetupNG<float>          CP_dev_360( "CP_DEV_360", 0 );
SetupNG<float>          CP_x_bias( "CP_X_BIAS", 0 );
SetupNG<float>          CP_y_bias( "CP_Y_BIAS", 0 );
SetupNG<float>          CP_z_bias( "CP_Z_BIAS", 0 );
SetupNG<float>          CP_x_scale( "CP_X_SCALE", 0 );
SetupNG<float>          CP_y_scale( "CP_Y_SCALE", 0 );
SetupNG<float>          CP_z_scale( "CP_Z_SCALE", 0 );
SetupNG<float>          CP_calibration_time( "CP_C_TIME", 10 );
SetupNG<bool>           CP_calibrated( "CP_CALIBRATED", 0 );
SetupNG<float>          CP_declination( "CP_DECL", 0 );
SetupNG<int>            CP_declination_valid( "CP_DECL_VALID", 0 );
SetupNG<int>            CP_nmea_hdm( "CP_NMEA_HDM", 0 );
SetupNG<int>            CP_nmea_hdt( "CP_NMEA_HDT", 0 );
