...
<<<<<<< HEAD
typedef enum nmea_protocol  { OPENVARIO, BORGELT, CAMBRIDGE, XCVARIO, XCVARIO_DEVEL, FLIGHT_TEST, GENERIC } nmea_proto_t;
...
extern SetupNG<int> 		nmea_streams;
...
extern SetupNG<mpud::float_axes_t> gyro_bias;
extern SetupNG<mpud::float_axes_t> accl_bias;
