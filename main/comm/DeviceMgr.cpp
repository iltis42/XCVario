...
constexpr std::pair<DeviceId, DeviceAttributes> DAVATTR[] = {
    ...
    {DeviceId::FLARM_CONSUMER_DEV, {"Flarm consumer", {{WIFI_AP, CAN_BUS}}, {{FLARMHOST_P, FLARMBIN_P}, 2}, 8881, MULTI_CONF}},
    {DeviceId::KRT2_HOST_DEV,   {"Radio remote", {{WIFI_AP}}, {{KRT2_REMOTE_P}, 1}, 8882, MULTI_CONF}},
