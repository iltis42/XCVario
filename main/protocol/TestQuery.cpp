...
bool TestQuery::sendTestQuery()
{
    ...
    // msg = newMessage();
    // msg->buffer = "$_123456789022345678903234567890423456789052345678906234567890723456789\r\n";
    // DEV::Send(msg);

    // msg = newMessage();
    // msg->buffer = "$__12345678902234567890323456789042345678905234567890623456789072345678\r\n";
    // DEV::Send(msg);

    msg = newMessage();
    msg->buffer = "$___1234567890223456789032345678904234567890523456789062345678907234567\r\n";
    return DEV::Send(msg);
}
