...
{
    ESP_LOGI(FNAME, "Send burst on Serial");
    Message* msg = newMessage();
    msg->buffer = "$A_1234567890223456789032345678904234567890523456789062345678907234567890\r\n";
    DEV::Send(msg);

    msg = newMessage();
    msg->buffer = "$B_1234567890223456789032345678904234567890523456789062345678907234567890\r\n";
    DEV::Send(msg);

    msg = newMessage();
    msg->buffer = "$C_1234567890223456789032345678904234567890523456789062345678907234567890\r\n";
    DEV::Send(msg);

    msg = newMessage();
    msg->buffer = "$D_1234567890223456789032345678904234567890523456789062345678907234567890\r\n";
    return DEV::Send(msg);
}
